...
const testimonials: Testimonial[] = [
  {
    ...
    avatarHint: 'man face',
    date: 'March 25, 2025',
    text: "Mansio made finding my flatmate a breeze! The AI recommendations were spot on, and I found someone who shares my love for plants and good Wi-Fi.",
  },
  {
    name: 'Sneha Gupta',
    avatar: 'https://placehold.co/100x100.png',
    ...
    date: 'March 22, 2025',
    text: "I was nervous about finding a stranger to live with, but Mansio's detailed profiles helped me find someone perfect. We're already best friends!",
  },
  {
    name: 'Raj Patel',
    avatar: 'https://placehold.co/100x100.png',
    ...
    date: 'March 23, 2025',
    text: 'Best decision ever! My new flatmate is clean, friendly, and we both love cooking. Thanks Mansio for making this so easy!',
  },
  {
    name: 'Priya Singh',
    avatar: 'https://placehold.co/100x100.png',
    ...
    date: 'March 24, 2025',
    text: 'Finally found the perfect flat AND flatmate through mansio. The matching system really works - we even have the same sleep schedule!',
  },
  {
    name: 'Vikram Kumar',
    avatar: 'https://placehold.co/100x100.png',
  ...
  },
  {
    ...
    date: 'March 20, 2025',
    text: "Mansio understood exactly what I was looking for. My flatmate and I both love the same Netflix shows - it's like we were meant to be roomies!",
  },
];
